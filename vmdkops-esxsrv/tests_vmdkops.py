...
#  WARNING: TODO: datastore needs to be a bit more dynamic !
path = "/vmfs/volumes/datastore/dockvols"
...
class VmdkCreateRemoveTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.name = vmci_srv.getVmdkName(path, self.volName)
...
# otherwise the logger from vmci_srv is just fine
def log_init():
...
if __name__ == '__main__':
    #log_init()
    vmci_srv.LogSetup("/var/log/vmware/docker-vmdk-plugin-pytest.log")
    kv.init()
    unittest.main()
